                  ...
                  <div className="mb-4">
                    <div className="flex flex-wrap gap-2">
                      {Array.isArray(sub.fileUrl) ? sub.fileUrl.map((file, idx) => (
                        <a key={idx} href={`${API_URL}/${file.replace(/^\/+/, "")}`} target="_blank" rel="noopener noreferrer"
                        ...
                        <a href={`${API_URL}/${sub.fileUrl.replace(/^\/+/, "")}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-lg text-xs font-medium hover:bg-blue-100 transition-colors border border-blue-100">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-xl p-3 flex flex-col items-center justify-center text-center">
                        ...
                        <div className="flex items-baseline gap-1 mt-1">
                          ...
                          <span className={`text-xs font-bold px-1.5 py-0.5 rounded ${sub.grade >= 8 ? 'bg-green-200 text-green-800' : sub.grade >= 5 ? 'bg-yellow-200 text-yellow-800' : 'bg-red-200 text-red-800'
                            }`}>
