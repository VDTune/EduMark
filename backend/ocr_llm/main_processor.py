...
def main():
    ...
    try:
        ...
        cleaned_result = clean_images_parallel(download_raw_paths, max_workers=4)
        ...
        ocr_results_rich = ocr_batch_parallel(cleaned_local, max_workers=4)
        ...
        grading_result = grade_multiple_submissions_parallel(submission_payload, max_workers=4)[0]
